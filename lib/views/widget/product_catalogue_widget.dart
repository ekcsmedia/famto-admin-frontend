...
class _ProductCatalogueScreenState extends State<ProductCatalogueScreen> {
  ...
  Widget build(BuildContext context) {
    return Obx (() => Flexible(
      flex: 4,
      child: _restaurantManagementController.isDataLoading ? const Center(
            ...
            children: [
              ...
              Padding(
                ...
                child:  DropdownMenu<RestaurantModel>(
                  ...
                  dropdownMenuEntries:
                  _restaurantManagementController.restaurantList.payload == null ? [] : _restaurantManagementController.restaurantList.payload!.map<DropdownMenuEntry<RestaurantModel>>(
